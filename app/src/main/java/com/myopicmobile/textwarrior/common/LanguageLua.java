...
public class LanguageLua extends Language {
	...
	private final static String keywordTarget ="and|break|case|continue|default|do|else|elseif|end|false|for|function|goto|if|in|local|nil|not|or|repeat|return|switch|then|true|until|while";
	...
	private final static String package_luajava = "astable|bindClass|clear|coding|createArray|createProxy|getContext|instanceof|loadLib|loaded|luapath|new|newInstance|package|tostring";
	...
	private final static String package_utf8 = "byte|char|charpattern|charpos|codepoint|codes|escape|find|fold|gmatch|gsub|insert|len|lower|match|ncasecmp|next|offset|remove|reverse|sub|title|upper|width|widthindex";
