...
public abstract class AsyncTaskX<Params, Progress, Result> {
    ...
    public enum Status {
        ...
        RUNNING,
        /**
         * Indicates that {@link AsyncTaskX#onPostExecute} has finished.
         */
        FINISHED,
    }
     ...
     * @hide
     */
    public AsyncTaskX( Looper callbackLooper) {
    ...
    public final AsyncTaskX<Params, Progress, Result> execute(Params... params) {
    ...
    private static class AsyncTaskResult<Data> {
        final AsyncTaskX mTask;
        final Data[] mData;

        AsyncTaskResult(AsyncTaskX task, Data... data) {
            mTask = task;
            mData = data;
        }
    }
