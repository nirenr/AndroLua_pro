...
import static com.android.cglib.dx.rop.code.Rop.BRANCH_GOTO;
import static com.android.cglib.dx.rop.code.Rop.BRANCH_NONE;
import static com.android.cglib.dx.rop.code.Rop.BRANCH_RETURN;
import static com.android.cglib.dx.rop.type.Type.BT_BYTE;
import static com.android.cglib.dx.rop.type.Type.BT_CHAR;
import static com.android.cglib.dx.rop.type.Type.BT_INT;
import static com.android.cglib.dx.rop.type.Type.BT_SHORT;
...
public final class Code {
   ...
   public <D, V> void iput(FieldId<D, V> fieldId, Local<D> instance, Local<V> source) {
    ...
    private Rop getCastRop(com.android.cglib.dx.rop.type.Type sourceType,
                           com.android.cglib.dx.rop.type.Type targetType) {
