...
public class PageView extends ViewGroup {
    ...
    // or end of the page data set during touch scrolling.
    ...
    public void setAdapter(BasePageAdapter adapter) {
        ...
        final BasePageAdapter oldAdapter = mAdapter;
        mAdapter = adapter;
        mExpectedAdapterCount = 0;

        if (mAdapter != null) {
            if (mObserver == null) {
                mObserver = new PageObserver();
            }
    ...
    void dataSetChanged() {
        ...
        for (int i = 0; i < mItems.size(); i++) {
            ...
            if (newPos == BasePageAdapter.POSITION_UNCHANGED) {
                continue;
            }

            if (newPos == BasePageAdapter.POSITION_NONE) {
                mItems.remove(i);
                i--;
    ...
    void populate(int newCurrentItem) {
        ...
        /*if (N != mExpectedAdapterCount) {
            ...
            throw new IllegalStateException("The application's PageAdapter changed the adapter's" +
                    " contents without calling PageAdapter#notifyDataSetChanged!" +
    ...
    private void dispatchOnPageSelected(int position) {
        if (mOnPageChangeListener != null) {
            ...
            mOnPageChangeListener.onPageChange(getChildAt(position), position);
        }
        if (mOnPageChangeListeners != null) {
            for (int i = 0, z = mOnPageChangeListeners.size(); i < z; i++) {
                OnPageChangeListener listener = mOnPageChangeListeners.get(i);
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_DOWN: {
                ...
                if (mScrollState == SCROLL_STATE_SETTLING &&
                    ...
                    // Let the user 'catch' the page as it animates.
                    mScroller.abortAnimation();
                    mPopulatePending = false;
                    populate();
                    mIsBeingDragged = true;
    ...
    /**
     * Start a fake drag of the page.
     * <p>
     * <p>A fake drag can be useful if you want to synchronize the motion of the PageView
     * with the touch scrolling of another view, while still letting the PageView
     * control the snapping motion and fling behavior. (e.g. parallax-scrolling tabs.)
     * Call {@link #fakeDragBy(float)} to simulate the actual drag motion. Call
     * {@link #endFakeDrag()} to complete the fake drag and fling as necessary.
     * <p>
     * <p>During a fake drag the PageView will ignore all touch events. If a real drag
    ...
    public boolean arrowScroll(int direction) {
        ...
        if (nextFocused != null && nextFocused != currentFocused) {
            if (direction == View.FOCUS_LEFT) {
                ...
                final int nextLeft = getChildRectInPageCoordinates(mTempRect, nextFocused).left;
                final int currLeft = getChildRectInPageCoordinates(mTempRect, currentFocused).left;
    ...
    private Rect getChildRectInPageCoordinates(Rect outRect, View child) {
        if (outRect == null) {
            outRect = new Rect();
        }
        if (child == null) {
    ...
    public void addTouchables(ArrayList<View> views) {
        ...
        // we don't call View.addTouchables().  This is okay because a PageView
    ...
    public boolean dispatchPopulateAccessibilityEvent(AccessibilityEvent event) {
        // Dispatch scroll events from this PageView.
    ...
    public interface OnPageChangeListener {
         ...
         * begins dragging, when the page is automatically settling to the current page,
         * or when it is fully stopped/idle.
         *
         * @param state The new scroll state.
         * @see PageView#SCROLL_STATE_IDLE
         * @see PageView#SCROLL_STATE_DRAGGING
     ...
     * setting a PageTransformer on a PageView on earlier platform versions will
     * be ignored.</p>
     */
    public interface PageTransformer {
         ...
         *                 position of the page. 0 is front and center. 1 is one full
    ...
    interface OnAdapterChangeListener {
        public void onAdapterChanged(BasePageAdapter oldAdapter, BasePageAdapter newAdapter);
    }

    /**
     * Used internally to tag special types of child views that should be added as
     * page decorations by default.
     */
    interface Decor {
    }
    ...
    /**
     * This is the persistent state that is saved by PageView.  Only needed
     * if you are creating a sublass of PageView that must save its own
    ...
    public static class SavedState extends BaseSavedState {
        ...
        public String toString() {
            return "FragmentPage.SavedState{"
    ...
    public static class LayoutParams extends ViewGroup.LayoutParams {
        /**
         * true if this view is a decoration on the page itself and not
        ...
        /**
         * Width as a 0-1 multiplier of the measured page width
         */
        ...
        /**
         * Current child index within the PageView that this view occupies
         */
        int childIndex;
