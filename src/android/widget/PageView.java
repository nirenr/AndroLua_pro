...
public class PageView extends ViewGroup {
    ...
    interface OnAdapterChangeListener {
        public void onAdapterChanged(PageAdapter oldAdapter, PageAdapter newAdapter);
    }
    ...
    public void setAdapter(PageAdapter adapter) {
        ...
        final PageAdapter oldAdapter = mAdapter;
        mAdapter = adapter;
    ...
    void dataSetChanged() {
        ...
        for (int i = 0; i < mItems.size(); i++) {
            ...
            if (newPos == PageAdapter.POSITION_UNCHANGED) {
                continue;
            }

            if (newPos == PageAdapter.POSITION_NONE) {
                mItems.remove(i);
                i--;
